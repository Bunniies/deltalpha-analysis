...
path_plot = "/Users/alessandroconigli/MyDrive/postdoc-mainz/projects/deltalpha/plots/isoscalar/piQ4_piQ0/ILD/"
...
enslist = sort([  "H101", "H102", "N101", "C101", "D150", #  C102  removed, 
          "B450", "N451", "D452",   #  D450, D451 removed
         "N202", "N203", "N200", "D200", "E250",  # D251 D201,  removed
          "J307", "J303", "E300",  # J304 removed
        "J500", "J501"]) 
...
fb = BDIO_open(joinpath(path_store_pi, "PI_88_ILD.bdio"), "r")
res = Dict()
count=0
...
#########################
using Statistics
ll = L"$\mathit{\bar\Pi}^{88,\mathrm{ILD}}(-Q^2/4)$"
...
io = IOBuffer()
write(io, "PI88 ILD low q  physical results")
fb = ALPHAdobs_create(joinpath(path_phys_res, "PI88_ILD_physRes.bdio"), io)
for k in eachindex(RES)
    aux = RES[k] + uwreal([0.0, SYST[k]], "Syst Pi88 ILD lowq")

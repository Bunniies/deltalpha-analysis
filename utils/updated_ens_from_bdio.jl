...
path_new_ens = joinpath(path_main,"tmp/PIcc_conn_newEnsStat.bdio")
path_old_bdio = joinpath(path_main, "old_data/res_old_stat/PIcc_conn.bdio")
path_save_updated_bdio = path_main


# ensembles = ["E300", "D251", "F300", "J306", "J307", "D450"] # ensembles to replace
ensembles = ["E300",  "D450"] # ensembles to replace

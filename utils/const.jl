...
m_ens = Dict(
    ...
    "C102" => Dict("m_pi" => uwreal([0.09671,0.00078], "mpi"), "m_K" => uwreal([0.21761,0.00047], "mK"), "m_rho" => uwreal([0.326,0.003], "mrho")), # rho not updated
    ...
    "D451" => Dict("m_pi" => uwreal([0.08359,0.00030], "mpi"), "m_K" => uwreal([0.19402,0.00014], "mK"), "m_rho" => uwreal([NaN,NaN],     "mrho")), # rho not updated
    "D452" => Dict("m_pi" => uwreal([0.05941,0.00055], "mpi"), "m_K" => uwreal([0.18651,0.00015], "mK"), "m_rho" => uwreal([NaN,NaN],     "mrho")),
    ...
    "D201" => Dict("m_pi" => uwreal([0.06499,0.00043], "mpi"), "m_K" => uwreal([0.16309,0.00024], "mK"), "m_rho" => uwreal([0.250,0.002], "mrho")), # rho not updated
    ...
    "J304" => Dict("m_pi" => uwreal([0.06550,0.00020], "mpi"), "m_K" => uwreal([0.13187,0.00017], "mK"), "m_rho" => uwreal([0.200,0.002], "mrho")), # rho not updated
    "E300" => Dict("m_pi" => uwreal([0.04393,0.00016], "mpi"), "m_K" => uwreal([0.12372,0.00010], "mK"), "m_rho" => uwreal([0.198,0.002], "mrho")),
    
    "J500" => Dict("m_pi" => uwreal([0.08153,0.00019], "mpi"), "m_K" => uwreal([0.08153,0.00019], "mK"), "m_rho" => uwreal([NaN,NaN],     "mrho")),
    "J501" => Dict("m_pi" => uwreal([0.06582,0.00023], "mpi"), "m_K" => uwreal([0.08794,0.00022], "mK"), "m_rho" => uwreal([NaN,NaN],     "mrho")),
)
...
# scale setting
const t0sqrt_ph = uwreal([0.1443, 0.0007], "sqrtt0 [fm]")  # Regensburg with error
# const t0sqrt_ph_noerr = uwreal([0.1443, 0.0000], "sqrtt0 [fm]")  # Regensburg without error

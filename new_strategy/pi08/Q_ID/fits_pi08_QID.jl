...
path_plot = "/Users/alessandroconigli/MyDrive/postdoc-mainz/projects/deltalpha/plots/new_strategy/pi08/Q_ID/"
...
fb = BDIO_open(joinpath(path_store_pi, "PI_08_QID.bdio"), "r")
res = Dict()
tmp_res = Dict()
count=0
...
fb = ALPHAdobs_create(joinpath(path_phys_res, "PI08_Q_ID_physRes.bdio"), io)
for k in eachindex(RES)
    aux = RES[k] + uwreal([0.0, SYST[k]], "Syst Pi08 Q_ID")
